package br.com.pierredev.auth;

import br.com.pierredev.auth.entity.Permission;
import br.com.pierredev.auth.entity.User;
import br.com.pierredev.auth.repositories.PermissionRepository;
import br.com.pierredev.auth.repositories.UserRepository;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
		...
		User find = userRepository.findByUserName("pierre");
		if (find == null) {
